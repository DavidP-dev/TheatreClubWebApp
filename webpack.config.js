...
const CONFIG = {
    ...
    indexHtmlTemplate: './src/TheatreClubWebApp.Client/index.html',
    fsharpEntry: './.fable-build/App.js',
    cssEntry: './src/TheatreClubWebApp.Client/styles/styles.css',
    outputDir: './publish/app/public',
    assetsDir: './src/TheatreClubWebApp.Client/public',
    devServerPort: 8080,
